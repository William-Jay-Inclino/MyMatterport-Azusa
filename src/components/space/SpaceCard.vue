        ...
        <div class="media-data">
          <div class="tile is-ancestor is-flex-wrap-wrap">
            <div
              ...
              v-for="child in spaceStore.spaceUnitChildren"
              :key="child.uuid"
            >
              <article
                ...
                <div class="columns card-icon-background">
                  <div class="column is-half is-offset-one-quarter">
                    <o-icon
                      ...
                      size="large"
                      class="card-icon"
                      v-if="child.type === SPACE_UNIT_TYPE.SECTION"
                    >
                    </o-icon>
                    <o-icon
                      pack="mdi"
                      ...
                      size="large"
                      class="card-icon"
                      v-else-if="child.type === SPACE_UNIT_TYPE.FACILITY"
                    >
                    </o-icon>
                  </div>
                  <div class="column is-full">
                    <figure
                      class="image 256x256"
                      v-if="child.type === SPACE_UNIT_TYPE.SPACE"
                    >
                      <!-- <img
                      width="256"
                      height="256"
