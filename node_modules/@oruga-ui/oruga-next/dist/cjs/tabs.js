...
require('./Icon-e1b4d3c8.js');
require('./InjectedChildMixin-c147450b.js');
require('./SlotComponent-b10f11e8.js');
var TabbedChildMixin = require('./TabbedChildMixin-09d401c1.js');
...
var script = vue.defineComponent({
    name: 'OTabs',
    mixins: [plugins$1.BaseComponentMixin, TabbedChildMixin.TabbedMixin('tab')],
    configField: 'tabs',
    props: {
        /**
         * Tab type
...
var script$1 = vue.defineComponent({
    name: 'OTabItem',
    mixins: [plugins$1.BaseComponentMixin, TabbedChildMixin.TabbedChildMixin('tab')],
    configField: 'tabs',
    props: {
